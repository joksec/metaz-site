...
export default function ServiceWeb() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Création de site web">
                <section className="Service-details pt-space pb-space">
                    <div className="container">
                        ...
                        <div className="thumb w-100 mb-xxl-12 mb-xl-9 mb-sm-6 mb-5" data-aos="zoom-in" data-aos-duration={1500}>
                                <img src="/assets/img/service/web.png" alt="img" className="w-100" />
                            </div>
                            <h3 className="white-clr mb-xxl-9 mb-xl-7 mb-lg-6 mb-4" data-aos="zoom-in-left" data-aos-duration={1600}>
                                Sites vitrines, e-commerce et landing pages rapides, SEO-friendly et centrés conversion.
                            </h3>
                            <div className="d-flex flex-wrap align-items-center gap-xxl-5 gap-xl-3 gap-2" data-aos="zoom-in-left" data-aos-duration={1800}>
                                <Link href="/service-details/creation-de-site-web" className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3 theme-clr">
                                    Site vitrine
                                </Link>
                                <Link href="/service-details/creation-de-site-web" className="radius-btn cmn-border radius100 py-xxl-2 py-2 px-xxl-4 px-3 theme-clr">
                                    E‑commerce
                        ...
                        <div className="case-study-detials-inner mt-xxl-10 mt-xl-7 mt-6">
                            ...
                            <div className="d-flex flex-md-nowrap flex-wrap justify-content-between gap-xxl-15 gap-xl-10 gap-lg-7 gap-sm-5 gap-3 mb-xxl-9 mb-xl-8 mb-lg-7 mb-4">
                                ...
                                Nous concevons des sites modernes et performants avec Next.js/React, optimisés pour le SEO et l'expérience utilisateur.
                                </p>
                                <p className="pra-clr">
                                De la stratégie à la mise en ligne, nous gérons le design, le développement, l’intégration de contenus, les performances et l’hébergement.
                                </p>
                            </div>
                            ...
                            <Swiper {...swiperOptions} className="swiper-wrapper">
                                <SwiperSlide>
                                    <div className="study-thumb-slide w-100">
                                        <img src="/assets/img/service/web-1.png" alt="img" className="w-100" />
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className="study-thumb-slide w-100">
                                        <img src="/assets/img/service/web-2.png" alt="img" className="w-100" />
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide>
                                    <div className="study-thumb-slide w-100">
                                        <img src="/assets/img/service/web-3.png" alt="img" className="w-100" />
                                    </div>
                                </SwiperSlide>
                            </Swiper>
                        </div>
